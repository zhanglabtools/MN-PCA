function [w, theta, iter, avgTol, hasError] = myGLasso(S, lambda, initStruct, approximate, warmInit, verbose, penalDiag, tolThreshold, maxIter, w, theta)
% [w, theta, iter, avgTol, hasError] = GraphicalLasso(S, lambda,
...
[w, theta, iter, avgTol, hasError] = glasso(numVars, S, 0, lambda, approximate, warmInit, verbose, penalDiag, tolThreshold, maxIter, w, theta);
