function [X, W, iA, iB, Out] = blkMnPCA(Y, dim, blk1, blk2, opts)
% MnPCA Matrix-normal PCA 
%   [X, W, iA, iB, Out] = MNPCA(Y, dim, opts.lam1, opts.lam2, opts)
% Input
%   Y: n * p input data matrix
%   dim: reduction dimension
%   blk1: label of clusters in sample space. [] for no blocks
%   blk2: label of clusterin in feature space.
